...
<body style="background: #f3f2f2">
    <div class="container-fluid" style="background: #473F97; color: #fff">
        <div class="container text-center">
            <div class="logo" style="display: inline-block; float: left">
                <img src="<?=base_url1("assets/plugins/images/erplogo.png")?>" style="padding-top:10px;height: 60px;">
            </div>
    ...
    <div class="container-fluid" style="background: #f3f2f2;padding-top: 50px;">
        <div class="container">
            <div class="col-md-6">
                <div class="login-box">
                    <div class="login-box-icon">
                        <div class="login-logo">
                            <img src="<?=base_url1("assets/plugins/images/erplogo1.png")?>" style="display: block;margin-left: auto;margin-right: auto;" alt="">
                            <br>
                        </div>
                    </div>
                    ...
                    <div class="imp-note-left">
                        ...
                        <ol style="font-size: 18px">
                            ...
                            <li>In case of any enquiry, support or problem you can mail us at&nbsp;<br>
                                <a href = "mailto: support@classplx.com"><span id="lblEmailId">support@classplx.com</span></a>&nbsp;</li>
                        </ol>
                    </div>
