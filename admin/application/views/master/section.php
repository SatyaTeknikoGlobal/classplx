...
<!-- <div class="row">
    <div class="col-sm-12">
        <div class="white-box">
            <h3 class="box-title m-b-0">SELECT CLASS</h3>
...
<div class="row">
    <div class="col-sm-8">
        <div class="white-box">
            <h3 class="box-title m-b-0"><?=$title?></h3>
             ...
             <div class="table-responsive">
                ...
                <table id="example23" class="display nowrap table table-hover table-striped" cellspacing="0" width="100%">
                    ...
                    {
                        $class = $this->db->get_where('admin_class',['classid'=>$section->class_id])->row();
            ...
            <!-- <div class="table-responsive">
                <table id="section_table1" class="display nowrap table table-hover table-striped" cellspacing="0" width="100%">
    ...
    <div class="col-sm-4">
        <div class="white-box">
            ...
            <p class="text-muted m-b-30 font-13"> Add Section </p>
            <form class="form-horizontal" method="post" enctype="multipart/form-data" id="form" action="<?=base_url("/sections/add_section")?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" required class="form-control" name="name" id="name" placeholder="Enter Section Name"> </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <input type="submit" class="btn btn-success" value="ADD SECTION" id="submit_btn"> </div>
                </div>
            </form>
        </div>
    </div>
