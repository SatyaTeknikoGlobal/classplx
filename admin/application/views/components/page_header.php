    ...
    <nav class="navbar navbar-default navbar-static-top m-b-0">
        <div class="navbar-header">
            <div class="top-left-part" style="display:inline-flex">
                ...
                <!-- Logo -->
                <a  href="<?=base_url()?>">
                    <img style="padding-top: 10px;height:60px;" src="<?=base_url1("assets")?>/plugins/images/erplogo.png" alt="home" class="dark-logo" /><!--This is light logo icon--><img height="100px" src="<?=base_url1("assets")?>/plugins/images/logo_dark.png" alt="home" class="light-logo" />
                    </b>
                </a>
            </div>
            <!-- /Logo -->
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav">
            <div class="sidebar-head">
                <h3><span class="fa-fw open-close"><i class="ti-menu hidden-xs"></i><i class="ti-close visible-xs"></i></span><img src="https://school.classplx.com/assets/plugins/images/erplogo1.png" style="height: 30px;"></h3> </div>
            <ul class="nav" id="side-menu">
                ...
                <li> <a href="<?=base_url("teacher")?>" class="waves-effect"><i class="mdi mdi-av-timer fa-fw" data-icon="v"></i> <span class="hide-menu"> Teacher </span></a>
                 ...
                 <li> <a href="<?=base_url("master")?>" onclick="return false" class="waves-effect"><i class="mdi mdi-clipboard-check fa-fw"></i> <span class="hide-menu">Master<span class="fa arrow"></span></span></a>
                    <ul class="nav nav-second-level">
                        <li><a href="<?=base_url()?>classes"><i class="fab fa-simplybuilt m-r-5"></i><span class="hide-menu">Classes</span></a></li>
                        <li><a href="<?=base_url()?>sections"><i class="fab fa-simplybuilt m-r-5"></i><span class="hide-menu">Sections</span></a></li>
                        <li><a href="<?=base_url()?>classes/subjects"><i class="fa fa-book m-r-5"></i><span class="hide-menu">Subjects</span></a></li>
                        <li><a href="<?=base_url()?>classes/chapter"><i class="fa fa-book m-r-5"></i><span class="hide-menu">Chapter</span></a></li>
                        <li><a href="<?=base_url()?>classes/contents"><i class="fa fa-database m-r-5"></i><span class="hide-menu">Content</span></a></li>
                    </ul>
                </li>
                <li> <a href="<?=base_url()?>quiz" onclick="return false" class="waves-effect"><i class="mdi mdi-clipboard-check fa-fw"></i> <span class="hide-menu">Quiz<span class="fa arrow"></span></span></a>
                    <ul class="nav nav-second-level">
                  ...
                  <li> <a href="<?=base_url("notifications")?>" class="waves-effect"><i class="fas fa-bell fa-fw" data-icon="v"></i> <span class="hide-menu"> Notification </span></a>
