...
<body style="background: #f3f2f2">
    <div class="container-fluid" style="background: #473F97; color: #fff;">
        <div class="container text-center">
            <div class="logo" style="display: inline-block; float: left" style="">
                <img src="<?=base_url("../assets/img/erplogo.png")?>" style="padding-top:10px;height: 60px;">
            </div>
                ...
                <div class="login-box">
                    <div class="login-box-icon">
                        <div class="login-logo">
                            <img src="<?=base_url("assets/plugins/images/erplogo1.png")?>" style=" display: block;margin-left: auto;margin-right: auto;" alt="">
                            <br>
                        </div>
                    </div>
