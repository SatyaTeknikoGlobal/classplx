                    ...
                    <tbody>
                        ...
                        <tr>                       
                            ...
                            <td>
                                ...
                                $html.= '<p><a class="btn btn-primary btn-sm" id="edit_class" href = "' . base_url("live_classes/edit/$lc->id") . '"><i class="fa fa-edit"></i></a></p>';
                                ...
                                <?php /*
    &nbsp;
                                <a class="btn btn-danger btn-sm" id="delete_class" onclick="return confirm(\'Are you sure want to delete this ?\');" href = "' . base_url("live_classes/delete/$lc->id") . '"><i class="fa fa-trash"></i></a>
                                */?>
