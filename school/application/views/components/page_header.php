        ...
        <div class="navbar-header">
            <div class="top-left-part" style="display:inline-flex">
                <ul class="nav navbar-top-links navbar-left">
                    <li><a href="javascript:void(0)" class="open-close waves-effect waves-light visible-xs"><i style="" class="ti-close ti-menu"></i></a></li>
                </ul>
                <!-- Logo -->

                <!-- src="<?php // echo base_url("uploads/logo/").$_SESSION['logo']?>" <?php //base_url("uploads/logo/").$_SESSION['logo']?> -->
                <a  href="<?=base_url()?>">
                    <img src="<?=base_url("assets/plugins/images/erplogo.png")?>" style="padding-top: 10px;height:60px;"   class="dark-logo"  /><!--This is light logo icon--><img  src="" alt="home" class="light-logo" />
                </b>
            </a>
        </div>
        <!-- /Logo -->
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user animated flipInY">
                    <li>
                        ...
                        <li role="separator" class="divider"></li>
                        <li><a href="<?= base_url('dashboard/my_profile')?>"><i class="fa fa-user"></i> My Profile</a></li>
                        <li role="separator" class="divider"></li>
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav">
            <div class="sidebar-head">
                <h3><span class="fa-fw open-close"><i class="ti-menu hidden-xs"></i><i class="ti-close visible-xs"></i></span> <span class="hide-menu"><img src="<?=base_url('assets/plugins/images/erplogo1.png')?>" style="height: 30px;"></span></h3> </div>
                <ul class="nav" id="side-menu">
                    ...
                    <?php if ($_SESSION['role'] == "school") { ?>
                        <li> <a href="<?=base_url()?>configuration" class="waves-effect non_clickable" onclick="return false"><i class="mdi mdi-settings fa-fw"></i> <span class="hide-menu">Configuration<span class="fa arrow"></span></span></a>
                            <ul class="nav nav-second-level">
                                ...
                                <li><a href="<?=base_url()?>configuration/chapter"><i class="fa fa-book m-r-5"></i><span class="hide-menu">Chapter</span></a></li>
                                <li><a href="<?=base_url()?>content/contents"><i class="fa fa-book m-r-5"></i><span class="hide-menu">Content</span></a></li>
                    ...
                    <?php if ($_SESSION['role'] == "school" || $_SESSION['role'] == "teacher") { ?>
            ...
            <li> <a href="<?=base_url()?>members" onclick="return false" class="waves-effect non_clickable"><i class="mdi mdi-account-multiple fa-fw"></i> <span class="hide-menu">Members<span class="fa arrow"></span></span></a>
                <ul class="nav nav-second-level">
                    ...
                    <?php }?>
                    <?php //if ($_SESSION['role']=="school"){?>
                        <!-- <li><a href="<?php //echo base_url()?>members/role_non_teaching"><i class="fa fa-lock m-r-5"></i><span class="hide-menu">Non Teaching Roles</span></a></li> -->
                        <?php //}?>
            ...
            <?php if ($_SESSION['role'] == "school"){?>
                <li> <a href="<?=base_url()?>accounts" onclick="return false" class="waves-effect non_clickable"><i class="mdi mdi-shield-outline fa-fw"></i> <span class="hide-menu">Accounts<span class="fa arrow"></span></span></a>
                    <ul class="nav nav-second-level">
                        <li><a href="<?=base_url()?>accounts/fee_head"><i class="fas fa-file-invoice"></i>&nbsp;<span class="hide-menu">Fee Head</span></a></li>
                        <li><a href="<?=base_url()?>accounts/fee_type"><i class="fas fa-file-invoice"></i>&nbsp;<span class="hide-menu">Fee Type</span></a></li>
                        <li><a href="<?=base_url()?>accounts/fee_structure"><i class="fas fa-file-invoice"></i>&nbsp;<span class="hide-menu">Fee Structure</span></a></li>
                        <li><a href="<?=base_url()?>accounts/concession"><i class="fas fa-file-invoice"></i>&nbsp;<span class="hide-menu">Concession</span></a></li>
                        <li><a href="<?=base_url()?>accounts/allocate_concession"><i class="fas fa-file-invoice"></i>&nbsp;<span class="hide-menu">Allocate Concession</span></a></li>
                        <li><a href="<?=base_url()?>accounts/generate_invoice"><i class="fas fa-file-invoice"></i>&nbsp;<span class="hide-menu">Generate Invoices</span></a></li>
                        <li><a href="<?=base_url()?>accounts/invoice"><i class="fas fa-file-invoice"></i>&nbsp;<span class="hide-menu">Invoices</span></a></li>
                        <li><a href="<?=base_url()?>accounts/payment"><i class="fas fa-file-invoice"></i>&nbsp;<span class="hide-menu">Student Wise Invoice</span></a></li>
                        <li><a href="<?=base_url()?>accounts/expense"><i class="fas fa-file-invoice"></i>&nbsp;<span class="hide-menu">Expense</span></a></li>
                        <li><a href="<?=base_url()?>accounts/reports"><i class="fas fa-file-invoice"></i>&nbsp;<span class="hide-menu">Reports</span></a></li>
                    </ul>
                </li>
            <?php }?>
                ...
                <li> <a href="<?=base_url()?>exam" onclick="return false" class="waves-effect non_clickable"><i class="mdi mdi-note fa-fw"></i> <span class="hide-menu">Exams<span class="fa arrow"></span></span></a>
                    <ul class="nav nav-second-level">
                        <?php if (strtolower($_SESSION['role'])=='school'){?>
                            <li><a href="<?=base_url()?>exam/index"><i class="fa fa-book-reader"></i>&nbsp;&nbsp;<span class="hide-menu">Exam</span></a></li>
                        <?php }?>
                        <li><a href="<?=base_url()?>exam/result"><i class="mdi mdi-note fa-fw"></i>&nbsp;<span class="hide-menu">Result</span></a></li>



                        <li><a href="<?=base_url()?>exam/exam_section"><i class="fa fa-book"></i>&nbsp;&nbsp;<span class="hide-menu">Exam Section Wise</span></a></li>
            ...
            <?php if ($_SESSION['role'] == "school") { ?>
                ...
                <?php if($_SESSION['role'] == "school" ||  $_SESSION['role'] == "teacher") { ?>
                    <li> <a href="<?=base_url()?>live_classes" class="waves-effect"><i class="mdi mdi-google-photos" data-icon="v"></i> <span class="hide-menu"> Live Classes </span></a>
                    </li>
                <?php } ?>
                ...
                <?php if ($_SESSION['role'] == "other_staff"){
                    $userID = $_SESSION['loginUserID'];
                    $module = [];
                    $role = $this->db->get_where('other_staff',['staffID'=>$userID])->row();
                    $modules = $this->db->get_where('modules',['is_active'=>'Y'])->result();

                    if(!empty($role)){
                        $role_id = $role->roleID;
                        if(!empty($role_id)){
                            $permission = $this->db->get_where('other_roles',['roleID'=>$role_id])->row();
                            if(!empty($permission)){
                    ...
                    if(!empty($module)){
                        if(!empty($modules)){
                            foreach($modules as $mod){
                                if(in_array($mod->moduleID, $module)){
                                    if($mod->module_name == 'Accounts & Fee'){?>
                                       <li> <a href="<?=base_url()?>accounts" onclick="return false" class="waves-effect non_clickable"><i class="mdi mdi-shield-outline fa-fw"></i> <span class="hide-menu">Accounts<span class="fa arrow"></span></span></a>
                                        <ul class="nav nav-second-level">
                                            <li><a href="<?=base_url()?>accounts/fee_head"><i class="fas fa-file-invoice"></i>&nbsp;<span class="hide-menu">Fee Head</span></a></li>
                                            <li><a href="<?=base_url()?>accounts/fee_type"><i class="fas fa-file-invoice"></i>&nbsp;<span class="hide-menu">Fee Type</span></a></li>
