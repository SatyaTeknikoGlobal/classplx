    ...
    public function role_non_teaching($param1 = "",$param2 = "")
    {
        if ($_SESSION['role']=="school"){
            ...
            if ($param1 == "edit" && $param2 != "" && $_POST){
                ...
                $this->data['modules'] = $this->db->query("SELECT moduleID,module_name as name FROM modules")->result();
                $this->data['roles'] = $this->db->get_where('other_roles',array('schoolID'=>$schoolID))->result();
                ...
                foreach($_FILES as $fileKey => $fileVal)
                {
                    ...
                    if (strtolower($extension == "csv")){
                        ...
                        if ($this->csvimport->get_array($file_path)) {
                            ...
                            $unupload[]=array('StudentID','Name','Date_of_birth','Roll','Phone','Email','Address','City','State','Pin_code','Password','Adhar_no','Remark');
                                ...
                                if (empty($school_studentID)){
                                    ...
                                    if (!empty($check_username)){
                                        ...
                                        $array = array(
                                            ...
                                            "phone" => $row["Phone"],
                                            "email" => $row["Email"],
                                            "adhar_no" => isset($row["Adhar_no"]) ? $row["Adhar_no"] :'',
                                            "batchID"=>$batchID,
