    ...
    public function add_chapter()
    {
        if ($_SESSION['role'] == "school")
        {
            ...
            foreach ($sectionID as $sectionID){
              ...
              $a =   $this->db->insert('chapters',array('schoolID'=>$schoolID,'classID'=>$classID,'sectionID'=>$sectionID,'subjectID'=>$subjectID,'chapter_name'=>$chapter_name,'is_active'=>$status,'added_on'=>date("Y-m-d H:i:s")));
            }
