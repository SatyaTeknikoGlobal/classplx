...
class Accounts extends MY_Controller
{
    ...
    public function send_email_attachment($subject, $message, $to, $attachment)
    {
        ...
        $result =
        /*  $this->email->from('anishashrivastava20@gmail.com');
          $this->email->to($to);
          $this->email->reply_to('anishashrivastava20@gmail.com');
          ...
          ->from('anishashrivastava20@gmail.com')
            ->reply_to('anishashrivastava20@gmail.com')    // Optional, an account where a human being reads.
            ->to($to)
            ->subject($subject)
            ->message($body)
            ->attach('https://school.classplx.com/invoices/'.$attachment)
            ->send();

        //return 'https://school.classplx.com/invoices/'.$attachment;
        ...
        {
            if ($_SESSION['role'] == "school" || $_SESSION['role'] == "other_staff")
            {   
                if($_SESSION['role'] == "school"){
                    $schoolID = $_SESSION['loginUserID'];

                }if($_SESSION['role'] == "other_staff"){
    ...
    // public function generate_invoice_old()
    // {
    //     if ($_SESSION['role']=="school")
    //     {
    //         $schoolID = $_SESSION['loginUserID'];
    ...
    //                      /* echo $this->db->last_query($students_array);
    //                                       die();*/
    ...
    //                                     $date = $dt->format("Y-m-d");//2021-12-01
    ...
    //                                                 //  echo $this->db->last_query($one_time_check );
    //                                                 // die();
    //                                                /* if (count($one_time_check) <= 0){*/
    //                                                  if(empty($one_time_check)){
    //                                                     $already = 0;
    //                                                 }else{
    //                                                     $already = 1;
    //                                                 }
    ...
    public function get_invoices()
    {
        if ($_SESSION['role'] == "school")
        {
            ...
            // echo $this->db->last_query($invoices);
            // die();
