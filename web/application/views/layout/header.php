...
<head>
    ...
    <script>
        (adsbygoogle = window.adsbygoogle || []).push({
            google_ad_client: "ca-pub-1211740728296007",
    ...
    <style>
        ...
        * {
        ...
        #contact input[type="text"], #contact input[type="email"], #contact input[type="tel"], #contact input[type="url"], #contact textarea, #contact button[type="submit"] { font:400 12px/16px "Open Sans", Helvetica, Arial, sans-serif; border-radius: 10px}
...
<title>Classplx: School management system</title>
<!-- Bootstrap CSS -->
...
<meta name="theme-color" content="#ffffff">
    ...
    <body data-spy="scroll" data-target=".header" data-offset="50">
        ...
        <header class="header">
            <div class="container">
                <div class="row flexbox-center" style="padding-top: 20px;">
                    <div class="col-lg-2 col-md-3 col-6">
                        <div class="logo" style="margin-top: -7px;">
                            <a href="#home"><img src="assets/img/erplogo.png" alt="logo" / > </a>
                        </div>
                    </div>
                    <div class="col-lg-10 col-md-9 col-6">
                        ...
                        <div class="mainmenu">
                            <ul id="primary-menu">
                                ...
                                <li><a class="btn btn-success text-white" href="<?=$this->config->item('school')?>" target="_blank"> School</a></li>
